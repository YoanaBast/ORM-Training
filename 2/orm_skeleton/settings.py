...
#     'default': {
#         'ENGINE': 'django.db.backends.postgresql',
#         'NAME': os.getenv('DB_NAME', 'orm_training_2'),
#         'USER': os.getenv('DB_USER'),          # <- this must read env variable!
#         'PASSWORD': os.getenv('DB_PASSWORD'),  # <- same here
#         'HOST': os.getenv('DB_HOST', 'localhost'),
#         'PORT': os.getenv('DB_PORT', '5432'),
#     }
# }
# print("DB_USER:", os.getenv('DB_USER'))
# print("DB_PASSWORD:", os.getenv('DB_PASSWORD') is not None)
# print(f"DB_PASSWORD raw value: {repr(os.getenv('DB_PASSWORD'))}")
