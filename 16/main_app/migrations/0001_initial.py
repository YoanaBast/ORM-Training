# Generated by Django 5.2.8 on 2025-11-20 23:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating', models.DecimalField(decimal_places=1, max_digits=2, validators=[main_app.validators.RangeValidator(max_value=Decimal('10.0'), message='The rating must be between 0.0 and 10.0', min_value=Decimal('0.0'))])),
            ],
        ),
        migrations.CreateModel(
            name='Invoice',
