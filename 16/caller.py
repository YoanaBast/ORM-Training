...
#
# # Print the results
# print("Action games:", action_games)
# print("Recently released games:", recent_games)
# print("Average rating:", average_rating)
# print("Highest rated game:", highest_rated)
# print("Lowest rated game:", lowest_rated)
# Create BillingInfo instances with real addresses
# billing_info_1 = BillingInfo.objects.create(
#     address="456 Oak Lane, Boston, MA 02108"
# )
#
# billing_info_2 = BillingInfo.objects.create(
#     address="789 Maple Avenue, San Francisco, CA 94101"
# )
#
# billing_info_3 = BillingInfo.objects.create(
...
#     billing_info=billing_info_1
# )
#
# invoice_2 = Invoice.objects.create(
#     invoice_number="INV002",
#     billing_info=billing_info_2
# )
#
# invoice_3 = Invoice.objects.create(
#     invoice_number="INV004",
#     billing_info=billing_info_3
# )
#
...
#     web_app_project = programmer.projects.get(name="Web App Project")
#     for technology in web_app_project.technologies_used.all():
