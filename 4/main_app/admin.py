...
class StudentAdmin(admin.ModelAdmin):
    ...
    fieldsets = (("Personal Information", {"fields": ("first_name", "last_name", "age", "date_of_birth")}),
...
class CourseAdmin(admin.ModelAdmin):
    ...
    fieldsets = (("Information", {"fields": ("title", "lecturer", "price", "start_date", "is_published")}),
...
class SmartphoneAdmin(admin.ModelAdmin):
    list_display = ('category', 'price', 'brand')

@admin.register(Order)
class OrderAdmin(admin.ModelAdmin):
    list_display = ('product_name', 'customer_name', 'order_date', 'warranty', 'delivery')
