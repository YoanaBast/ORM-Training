...
lecturer_profile = LecturerProfile.objects.create(lecturer=lecturer,

email="john.doe@university.lecturers.com", bio="A skilled and passionate math lecturer", office_location="Sofia, Al. Stamobolyiski Str, Faculty of Mathematics and Computer Science, Room 101")
